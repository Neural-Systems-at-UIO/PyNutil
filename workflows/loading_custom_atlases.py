...
pnt = PyNutil(
    ...
    colour=[0, 0, 0],
    atlas_path="/mnt/z/HBP_analytics/PyNutil/metadata/annotation_volumes/annotation_10_reoriented_2017.nrrd",
    label_path="/mnt/z/HBP_analytics/PyNutil/metadata/annotation_volumes/allen2017_colours.csv",
)
pnt.get_coordinates(object_cutoff=0)
pnt.quantify_coordinates()
pnt.save_analysis("../tests/outputs/PyNutil_nonlinear_noflat_custom")
