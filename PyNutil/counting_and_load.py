...
def PixelCountPerRegion(labelsDict, label_colours): 
    """Function for counting no. of pixels per region per brain and writing to CSV based on 
    ...
    df_counts_per_label = pd.DataFrame(counts_per_label, columns=["idx","object_area"])
